...
const AboutPage: React.FC<AboutPageProps> = ({ onBack, onNavigateToEvents, onNavigateToElves }) => {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      description: 'Received 501(c)(3) status. Expanded the number of families helped and expanded our network of Elves (volunteers).',
      icon: Users,
      color: 'bg-orange-500'
    },
    {
